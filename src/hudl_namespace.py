...
blocked_by='BLOCKED BY PBP'
taken_by='TAKEN BY'
touchdown='TOUCHDOWN'
placekicker='PK'
fumbled_by='FUMBLED BY PBP'
recover_team='RECOVER TEAM'
recovered_by='RECOVERED BY PBP'
...
no_play='NO PLAY'
nullified='NULLIFIED'
intercepted_by='INTERCEPTED BY PBP'
safety='SAFETY'
broken_up_by='BROKEN UP BY PBP'
hurried_by='HURRIED BY PBP'
two_point_attempt='2 PT RESULT'
forced_by='FORCED BY PBP'
quarter_end='QTR END'
half_end='HALF END'
game_end='GAME END'
pen_team='PEN TEAM'
...
toss_kick = 'Kick'
fz_backed_up = 'Backed Up'
fz_coming_out = 'Coming Out'
fz_gold_zone = 'Gold Zone'
fz_go_zone = 'Go Zone'
fz_take_a_shot = 'Take A Shot'
fz_redzone_high = 'Red Zone High'
fz_redzone = 'Red Zone'
fz_redzone_low = 'Red Zone Low'
